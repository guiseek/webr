...
export class FormArray<T = any, E extends object = any> extends NgFormArray {
  ...
  readonly status$: Observable<any> = controlStatusChanges$(this)
  ...
  setValue(
    valueOrObservable: Observable<ControlValue<T>[]>,
    options?: ControlEventOptions
  ): Subscription
  setValue(
    valueOrObservable: ControlValue<T>[],
    options?: ControlEventOptions
  ): void
  setValue(
  ...
  patchValue(
    valueOrObservable: DeepPartial<ControlValue<T>>[],
    options?: ControlEventOptions
  ): void
  patchValue(
    ...
    if (isObservable(valueOrObservable)) {
      return valueOrObservable.subscribe((value: T[] | any) => {
