...
> extends NgFormGroup {
  ...
  readonly disabled$: Observable<boolean> = controlDisabled$<ControlsValue<T>>(
    this
  )
  readonly enabled$: Observable<boolean> = controlEnabled$<ControlsValue<T>>(
    this
  )
  readonly status$: Observable<any> = controlStatusChanges$<ControlsValue<T>>(
    this
  )
  ...
  select<R>(mapFn: (state: ControlsValue<T | T[]>) => R): Observable<R> {
    return selectControlValue$(this as any, mapFn)
  }
  ...
  >(
    path: [K1, K2]
  ): AbstractControlsOf<T>[K1] extends FormGroup | FormArray
    ? AbstractControlsOf<T>[K1]['controls'][K2]
    : never
  ...
  >(
    prop1: P1,
    prop2: P2
  ): AbstractControlsOf<T>[P1] extends FormGroup | FormArray
    ? AbstractControlsOf<T>[P1]['controls'][P2]
    : never
  getControl<
    P1 extends keyof ControlsValue<T>,
    P2 extends keyof ControlsValue<T>[P1]
  >(prop1: P1, prop2: P2): AbstractControl<ControlsValue<T>[P1][P2]>
  getControl<
    P1 extends keyof ControlsValue<T>,
    P2 extends keyof ControlsValue<T>[P1],
  ...
  addControl<K extends ExtractStrings<T>>(
    name: K,
    control: AbstractControlsOf<T>[K]
  ): void {
  ...
  setControl<K extends ExtractStrings<T>>(
    name: K,
    control: AbstractControlsOf<T>[K]
  ): void {
  ...
  setValue(
    valueOrObservable: Observable<ControlsValue<T>>,
    options?: ControlEventOptions
  ): Subscription
  setValue(
    valueOrObservable: ControlsValue<T>,
    options?: ControlEventOptions
  ): void
  ...
  patchValue(
    valueOrObservable: Observable<DeepPartial<ControlsValue<T>>>,
    options?: ControlEventOptions
  ): Subscription
  patchValue(
    valueOrObservable: DeepPartial<ControlsValue<T>>,
    options?: ControlEventOptions
  ): void
  patchValue(
  ...
  mergeAsyncValidators(validators: AsyncValidator) {
    this.setAsyncValidators([
      this.asyncValidator as ValidatorFn,
      ...(coerceArray(validators) as ValidatorFn[]),
    ])
  ...
  reset(
    formState?: DeepPartial<ControlsValue<T>>,
    options?: ControlEventOptions
  ): void {
  ...
  hasError<
    K1 extends keyof ControlsValue<T>,
    K2 extends keyof ControlsValue<T>[K1]
  >(errorCode: ExtractStrings<E>, path?: [K1, K2]): boolean
  hasError<
    K1 extends keyof ControlsValue<T>,
    K2 extends keyof ControlsValue<T>[K1],
    K3 extends keyof ControlsValue<T>[K1][K2]
  ...
  setErrors(errors: Partial<E> | null, opts: EmitEvent = {}) {
    this.errorsSubject.next(errors as any)
    return super.setErrors(errors, opts)
  }

  mergeErrors(errors: Partial<E>, opts: EmitEvent = {}): void {
    this.setErrors(mergeErrors<E>(this.errors as any, errors), opts)
  }

  removeError(key: keyof E, opts: EmitEvent = {}): void {
    this.setErrors(removeError<E>(this.errors as any, key), opts)
  }

  getError<K extends keyof E, K1 extends keyof ControlsValue<T>>(
    errorCode: K,
    path?: [K1]
  ): E[K] | null
  getError<
  ...
  hasErrorAndTouched<
    P1 extends keyof ControlsValue<T>,
    P2 extends keyof ControlsValue<T>[P1]
  >(error: ExtractStrings<E>, prop1?: P1, prop2?: P2): boolean
  hasErrorAndTouched<
    P1 extends keyof ControlsValue<T>,
    P2 extends keyof ControlsValue<T>[P1],
    P3 extends keyof ControlsValue<T>[P1][P2]
