...
export interface AbstractControlOptions<T = any, E = any>
...
export interface AbstractControl<T = any, E extends object = any>
 ...
 * */
export type ControlValue<T> = T extends
  | FormControl
  | FormGroup
  | FormArray
  | AbstractControl
...
type AbstractControlOfWithPotentialUnion<T> = [T] extends [AbstractControl]
  ...
  : AbstractControl<T>
export type AbstractControlOf<
  T
> = AbstractControl extends AbstractControlOfWithPotentialUnion<T>
 ...
 * });
 * */
type ExtractAny<T> = T extends Extract<
  T,
...
export type ControlsOf<
  T extends Object,
  TOverrides extends Partial<AbstractControlsOf<T>> = {}
> = {
  [key in keyof T]: unknown extends TOverrides[key]
    ? ControlOf<T[key]>
    : TOverrides[key]
}
